...
import { ArrowDown10, ArrowDownZA, ArrowUp01, ArrowUpAZ, ArrowUpDown } from "lucide-react"
...
export const SortIcon = ({
  ...
  const upIcon = isNumber ? (
    <ArrowUp01 className={iconClasses} />
  ) : (
    <ArrowUpAZ className={iconClasses} />
  )
