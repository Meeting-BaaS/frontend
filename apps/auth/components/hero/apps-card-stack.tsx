...
import { GLADIA_URL } from "@repo/shared/lib/external-urls"
    ...
    <>
      ...
      >
        ...
        <motion.div variants={cardItemVariant()}>
          ...
          <div className="text-muted-foreground text-sm">Send bot to meetings in seconds</div>
        </motion.div>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <motion.div variants={cardItemVariant()}>
          ...
          >
            ...
            <rect x="0.00976562" y="0.376953" width="46.2077" height="9.06034" rx="4.53017" />
            <rect x="61.6201" y="0.376953" width="91.5094" height="9.06034" rx="4.53017" />
            <rect x="168.532" y="0.376953" width="11.7784" height="9.06034" rx="4.53017" />
            <rect x="0.00976562" y="14.873" width="66.1405" height="9.06034" rx="4.53017" />
            <rect x="81.5527" y="14.873" width="97.8516" height="9.06034" rx="4.53017" />
            <rect x="0.00976562" y="29.3691" width="104.194" height="9.06034" rx="4.53017" />
          </svg>
        </motion.div>
      </motion.div>
